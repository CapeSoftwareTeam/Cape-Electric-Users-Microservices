...
public class UserControllerTest {
	...
	public void testRetrieveUserInformation() throws UserException {
		...
		when(userDetailsServiceImpl.retrieveUserInformation("lvsystem@capeindia.net")).thenReturn(user);
		User userInfo = userController.retrieveUserInformation("lvsystem@capeindia.net");
